...
pub mod reflection {
    ...
    const ENUM_NAMES_BASE_TYPE: [&'static str; 17] = [
        ...
        "ULong", "Float", "Double", "String", "Vector", "Obj", "Union",
    ];
    ...
    impl<'a> EnumVal<'a> {
        ...
        pub fn object(&self) -> Option<Object<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Object<'a>>>(EnumVal::VT_OBJECT, None)
        }
        #[inline]
        pub fn union_type(&self) -> Option<Type<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Type<'a>>>(EnumVal::VT_UNION_TYPE, None)
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> EnumValBuilder<'a, 'b> {
        ...
        pub fn add_object(&mut self, object: flatbuffers::WIPOffset<Object<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<Object>>(EnumVal::VT_OBJECT, object);
        }
        #[inline]
    ...
    impl<'a> Enum<'a> {
        ...
        pub fn values(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<EnumVal<'a>>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<flatbuffers::ForwardsUOffset<EnumVal<'a>>>,
                >>(Enum::VT_VALUES, None)
                .unwrap()
        }
        #[inline]
        ...
        pub fn underlying_type(&self) -> Type<'a> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Type<'a>>>(Enum::VT_UNDERLYING_TYPE, None)
                .unwrap()
        }
        #[inline]
        pub fn attributes(
    ...
    impl<'a> Field<'a> {
        ...
        pub fn type_(&self) -> Type<'a> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Type<'a>>>(Field::VT_TYPE_, None)
                .unwrap()
        }
        #[inline]
        pub fn id(&self) -> u16 {
    ...
    impl<'a> RPCCall<'a> {
        ...
        pub fn request(&self) -> Object<'a> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Object<'a>>>(RPCCall::VT_REQUEST, None)
                .unwrap()
        }
        #[inline]
        pub fn response(&self) -> Object<'a> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Object<'a>>>(RPCCall::VT_RESPONSE, None)
                .unwrap()
        }
        #[inline]
        pub fn attributes(
    ...
    impl<'a> Service<'a> {
        ...
        pub fn calls(
            ...
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<flatbuffers::ForwardsUOffset<RPCCall<'a>>>,
    ...
    impl<'a> Schema<'a> {
        ...
        pub fn objects(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Object<'a>>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<flatbuffers::ForwardsUOffset<Object<'a>>>,
        ...
        pub fn root_table(&self) -> Option<Object<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Object<'a>>>(Schema::VT_ROOT_TABLE, None)
        }
        #[inline]
        pub fn services(
            &self,
            ...
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<flatbuffers::ForwardsUOffset<Service<'a>>>,
