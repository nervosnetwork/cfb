...
impl<'a> Bag<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args BagArgs) -> flatbuffers::WIPOffset<Bag<'bldr>> {
  ...
  pub fn color(&self) -> Color {
    self._tab.get::<Color>(Bag::VT_COLOR, Some(Color::Red)).unwrap()
  }
}
...
impl<'a: 'b, 'b> BagBuilder<'a, 'b> {
  ...
  pub fn add_color(&mut self, color: Color) {
    self.fbb_.push_slot::<Color>(Bag::VT_COLOR, color, Color::Red);
  }
  #[inline]
